...
class Config(dict):
    ...
    def check_and_infer(self):
        ...
        train_sets = codecs.open(
            self.DATASET.TRAIN_FILE_LIST, 'r', 'utf-8').readlines()
        val_sets = codecs.open(self.DATASET.VAL_FILE_LIST,
                               'r', 'utf-8').readlines()
        test_sets = codecs.open(
            self.DATASET.TEST_FILE_LIST, 'r', 'utf-8').readlines()
    ...
    def update_from_list(self, config_list):
        """update config from config list file
